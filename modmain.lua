...
-- Skin Creator:
----------------
GLOBAL.PREFAB_SKINS.crate_wooden =
{
    "crate_wooden_gingerbread",
    "crate_wooden_3d",
	"crate_wooden_scary",
...
local function PlayerControllerPostInit( playercontroller )
    ...
    playercontroller.StartBuildPlacementMode = function( self, recipe, skin )
		...
		if recipe ~= nil and recipe.skinnable ~= nil and skin ~= nil and (skin == "crate_wooden_gingerbread" or skin == "crate_wooden_scary" or skin == "crate_wooden_3d" or skin == "crate_wooden_present") then
			...
			if skin == "crate_wooden_gingerbread" then
				self.placer = SpawnPrefab("crate_wooden_placer_gingerbread")					
			elseif skin == "crate_wooden_3d" then
