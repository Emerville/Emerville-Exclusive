...
local function fn(Sim)
    ...
    inst.components.inventoryitem.imagename = "geargoggles"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/geargoggles.xml"
...
return Prefab("common/inventory/geargoggles", fn, assets)
