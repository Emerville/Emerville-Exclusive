...
local function onexplode(inst)
 ...
 local ents = TheSim:FindEntities(x, y, z, inst.size * 8, nil, NON_SMASHABLE_TAGS, SMASHABLE_TAGS)
        ...
        if v.components.combat ~= nil then
				 if v:HasTag("player") or v:HasTag("character") then
                    ...
                    v.components.combat:GetAttacked(inst.OFFSPELLCASTER, 20, nil)
...
return Prefab("clawmeteor", fn, assets, prefabs)
