...
local function onperish(inst)
	SpawnPrefab("propsignshatterfx").Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst:DoPeriodicTask(120, onperish)
...
return Prefab("common/inventory/greencanefake", fn, assets)