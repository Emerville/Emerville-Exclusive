...
local function MakeLoot(inst)
    local possible_loot =
    {
		{chance = 5,    item = "dollwolfgang"},
        {chance = 5,    item = "dollwilson"},	
        {chance = 5,    item = "dollwigfrid"},
		{chance = 5,    item = "dollwillow"},
		{chance = 5,    item = "dollwendy"},	
		{chance = 5,    item = "dollwx"},	
		{chance = 5,    item = "dollwicker"},			
		{chance = 5,    item = "dollwes"},
		{chance = 5,    item = "dollmaxwell"},			
        {chance = 5,    item = "dollwoodie"},
        {chance = 5,    item = "dollwebber"},		
		{chance = 5,    item = "dollwinona"},
		{chance = 5,    item = "dollwormwood"},			
        {chance = 5,    item = "dollwortox_uncorrupted"},
        {chance = 5,    item = "dollwurt_abyssal"},	
        {chance = 5,    item = "dollwarly"},
        {chance = 5,    item = "dollwalter"},	
        {chance = 5,    item = "dollmystery"},		
    }
    local totalchance = 0
