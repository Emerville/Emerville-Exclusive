local assets =
{
   Asset("ANIM", "anim/lightning_barrier.zip")
}
...
local function fn(Sim)
    ...
    inst.AnimState:SetBank("lightning_barrier")
    inst.AnimState:SetBuild("lightning_barrier")
...
return Prefab( "lightning_barrier", fn, assets)
