...
local function fn()
	...
	inst.components.inventoryitem.imagename = "gears_mace"		
    inst.components.inventoryitem.atlasname = "images/inventoryimages/gears_mace.xml"
...
return Prefab("common/inventory/gears_mace", fn, assets) 