local assets =
{
	Asset("ANIM", "anim/hat_goggles.zip"),
...
local function onequip(inst, owner)
	owner.AnimState:OverrideSymbol("swap_hat", "hat_goggles", "swap_hat")
...
local function fn(Sim)
	...
	inst.components.inventoryitem.imagename = "hat_goggles"	
	inst.components.inventoryitem.atlasname = "images/inventoryimages/hat_goggles.xml"	
...
return Prefab("common/inventory/hat_goggles", fn, assets) 