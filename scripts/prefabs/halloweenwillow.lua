...
local function Greetings(inst)
    inst.components.talker:Say("Welcome to Emerville!")
	inst.SoundEmitter:PlaySound("dontstarve/characters/willow/emote")	
...
return Prefab("halloweenwillow", fn, assets)