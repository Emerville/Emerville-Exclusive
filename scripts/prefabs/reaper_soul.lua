local reaper_soul_common = require("prefabs/reaper_soul_common")

local assets =
{
    Asset("ANIM", "anim/reaper_soul_ball.zip"),
    Asset("SCRIPT", "scripts/prefabs/reaper_soul_common.lua"),
}
...
local function KillSoul(inst)
    ...
    reaper_soul_common.DoHeal(inst)
end
...
local function fn()
    ...
    inst.AnimState:SetBank("reaper_soul_ball")
    inst.AnimState:SetBuild("reaper_soul_ball")
...
return Prefab("common/inventory/reaper_soul", fn, assets, prefabs)