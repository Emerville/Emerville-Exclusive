local assets =
{
    Asset("ANIM", "anim/reaper_soul_heal_fx.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("reaper_soul_heal_fx")
    inst.AnimState:SetBuild("reaper_soul_heal_fx")
...
return Prefab("reaper_soul_heal_fx", fn, assets)