require "tuning"
local GREEN = _G.KnownModIndex:IsModEnabled("workshop-1290063173")

local function MakeVegStats(seedweight, hunger, health, perish_time, sanity, cooked_hunger, cooked_health, cooked_perish_time, cooked_sanity, oneaten)
    return {
        health = health,
        hunger = hunger,
...
local function OnEaten(inst, eater)
	...
	eater:DoTaskInTime(5, turnoffspeed)
end
