...
local function Dry(inst)
    ...
    inst.state = "DRY"
    inst:AddTag("water_source_dry")
end

local function Fill(inst)
    inst.currentanim = "work"
    inst.state = "FULL"
    inst:RemoveTag("water_source_dry")
end
...
local function inspect_stat(inst)
    return (inst:HasTag("water_source_nolimit") and "FULL")
        or (inst:HasTag("water_source_dry") and "DRY")
...
local function fn()
    ...
    minimap:SetIcon("statue_charlie.tex")
    ...
    inst.state = "FULL"
    inst:AddTag("water_source")
    inst:AddTag("water_source_nolimit")
...
return Prefab("statue_charlie", fn, assets, prefabs),
	MakePlacer("statue_charlie_placer", "des_fsp_grand_final_fix", "des_fsp_grand_final_fix", "fsp_cycle")
