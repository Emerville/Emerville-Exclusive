...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "gears_staff"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/gears_staff.xml"
...
return Prefab("common/inventory/gears_staff", fn, assets)
