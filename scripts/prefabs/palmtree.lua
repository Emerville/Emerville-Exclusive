...
--	 Asset("IMAGE", "images/minimap/dontreepalm_icon.tex"),
--	 Asset("ATLAS", "images/minimap/dontreepalm_icon.xml"),
}
...
--SetSharedLootTable('donpalmtree',  {{"log", 1.0}, {"pinecone", 1.0}})
---SetSharedLootTable('donpalmtree_short',  {{"log", 1.0}, {"donpalmleaf", 1.0}})
---SetSharedLootTable('donpalmtree_normal', {{"log", 1.0},{"donpalmleaf", 0.6}, {"doncoconut", 0.8}})
---SetSharedLootTable('donpalmtree_tall',  {{"log", 1.0}, {"donpalmleaf", 1.0}, {"doncoconut", 1.0}, {"log", 0.33},{"doncoconut", 0.6}})

SetSharedLootTable('donpalmtree_short',  {{"log", 1.0}, {"pinecone", 1.0}})
SetSharedLootTable('donpalmtree_normal', {{"log", 1.0},{"pinecone", 0.6}, {"twigs", 0.8}})
SetSharedLootTable('donpalmtree_tall',  {{"log", 1.0}, {"pinecone", 1.0}, {"twigs", 1.0}, {"log", 0.33},{"cut_grass", 0.6}})
...
local builds =
{
	normal = {
		...
		normal_loot = 'donpalmtree_normal',
		short_loot = 'donpalmtree_short',
		tall_loot = 'donpalmtree_tall',
		leif="treeguard",
	},
...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
	    ...
	    inst.MiniMapEntity:SetIcon("dontreepalm_icon.tex")
