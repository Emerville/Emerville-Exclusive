...
CommonStates.AddCombatStates(states,
{
    attacktimeline =
    {
        ...
        TimeEvent(8* FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/bat/bite")
inst.SoundEmitter:PlaySound("dontstarve/sanity/bishop/taunt")
    ...
    deathtimeline =
    {
        TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/sanity/death_pop") end),
...
return StateGraph("shadowbatenemy", states, events, "idle", actionhandlers)
